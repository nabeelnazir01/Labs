        ...
        <div class="row">
            ...
            <div class="col-sm">
                ...
                if (isset($_POST['submit'])) {
                    echo "<p> Employee Name: " . $_POST["eName"] . "</p>";
                    echo "<p> Employee ID: " . $_POST["eID"] . "</p>";
                    echo "<p> Telephone Number: " . $_POST["tNum"] . "</p>";
                    echo "<p> Email Address: " . $_POST["eAdd"] . "</p>";
                    echo "<p> Position: " . $_POST["pos"] . "</p>";
